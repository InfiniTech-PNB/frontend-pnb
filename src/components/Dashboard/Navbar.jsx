                    ...
                    {menuItems.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all ${isActive ? 'bg-amber-50 text-amber-600' : 'text-slate-500 hover:bg-slate-50'
                                    }`}
                            >
                        ...
                        {menuItems.map((item) => {
                            ...
                            return (
                                <button
                                    key={item.name}
                                    onClick={() => handleNavigation(item.path)}
                                    className={`flex items-center gap-4 px-4 py-4 rounded-xl text-sm font-bold transition-all ${isActive ? 'bg-amber-50 text-amber-600' : 'text-slate-600 hover:bg-slate-50'
                                        }`}
                                >
