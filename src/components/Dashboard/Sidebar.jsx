            ...
            >
                <div className="px-8 py-8 border-b" style={{ borderColor: 'color-mix(in srgb, var(--outline) 45%, transparent)' }}>
                    <div className="flex items-start justify-between gap-4">
                        ...
                        >
                            <p className="editorial-title text-2xl leading-none">PNB Secure</p>
                ...
                <nav className="flex-1 py-5 overflow-y-auto">
                    {menuItems.map((item) => (
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `group mx-3 mb-2 flex items-center gap-3 rounded-xl border-r-4 px-4 py-3 text-[15px] transition-all ${
                                    isActive
                ...
                <div className="border-t px-6 py-6" style={{ borderColor: 'color-mix(in srgb, var(--outline) 45%, transparent)' }}>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <button
                            type="button"
                            className="editorial-button editorial-button-ghost inline-flex items-center justify-center gap-2 px-3 py-2"
                        >
                            <Settings size={14} />
                            Settings
                        </button>
                        <button
                            ...
                            className="editorial-button inline-flex items-center justify-center gap-2 px-3 py-2"
                            style={{
